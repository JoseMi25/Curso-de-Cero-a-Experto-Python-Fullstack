...
class ClienteDAO:
    SEELECCIONAR = 'SELECT * FROM cliente ORDER BY id'
    INSERTAR = 'INSERT INTO cliente(nombre, apellido, membresia) VALUES (%s,%s,%s)'
    SEELECCIONAR_ID = 'SELECT * FROM cliente WHERE id=%s'
    ...
    def seleccionar(cls):
        ...
        try:
            ...
            cursor.execute(cls.SEELECCIONAR)
    ...
    def seleccionar_por_id(cls, id):
        ...
        try:
            ...
            cursor = conexion.cursor()
            valores = (id, )
            cursor.execute(cls.SEELECCIONAR_ID, valores)
            registro = cursor.fetchone()
            #Mapeo de clase-tabla cliente
            cliente = cliente = Cliente(registro[0],registro[1],
                                  registro[2],registro[3])
            return cliente
    ...
    def insertar(cls, cliente):
        ...
        try: 
            ...
            print (f"Ocurrio un error al insertar a un cliente")
    ...
    def actualizar(cls, cliente):
        ...
        try: 
            ...
            print (f"Ocurrio un error al actualizar a un cliente")
    ...
    def eliminar(cls, cliente):
        ...
        try: 
            ...
            print (f"Ocurrio un error al eliminar a un cliente")
...
if __name__ == '__main__':
    ...
    #print(f"Clientes insertados: {clientes_eliminados}")
